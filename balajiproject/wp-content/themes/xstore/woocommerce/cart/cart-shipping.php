...
<tr class="woocommerce-shipping-totals shipping">
    ...
    //
        ...
        elseif ( ! is_cart() ) :
			...
			// Translators: $s shipping destination.
			echo wp_kses_post( apply_filters( 'woocommerce_cart_no_shipping_available_html', sprintf( esc_html__( 'No shipping options were found for %s.', 'xstore' ) . ' ', '<strong>' . esc_html( $formatted_destination ) . '</strong>' ) ) );
